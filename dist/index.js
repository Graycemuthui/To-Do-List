...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Actions\": () => (/* binding */ Actions)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\n/* eslint-disable */\nclass Actions {\n  static showTrash = (i) => {\n    // show the trash icon and hide the ellipsis icon\n    document.getElementById(`trash-${i}`).classList.remove(\"hide\");\n    document.getElementById(`ellipsis-${i}`).classList.add(\"hide\");\n  };\n\n  static hideTrash = (i) => {\n    // hide the trash icon and show the ellipsis icon\n    document.getElementById(`trash-${i}`).classList.add(\"hide\");\n    document.getElementById(`ellipsis-${i}`).classList.remove(\"hide\");\n  };\n\n  static removeTask = (i) => {\n    // Remove the task from the array\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(i, 1);\n    // Reorder the index of tthe objects in the array\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())((item, index) => {\n      item.index = index;\n    });\n    // Store in local storage\n    localStorage.setItem(\"tasks\", JSON.stringify(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));\n    // Refresh the task list.\n    return true;\n  };\n\n  static addTask = (description, i) => {\n    // Get the value of the user-input\n    // Update the specific tasks in our array\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())[i].description = description;\n    // Store in local storage\n    localStorage.setItem(\"tasks\", JSON.stringify(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './tasks'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));\n    // Refresh the task list.\n    return true;\n  };\n}\n\n\n//# sourceURL=webpack://webpack-demo/./src/modules/actions.js?");
